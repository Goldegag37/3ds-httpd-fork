...
http_response *get_default_page(http_request *request)
{
	...
	sprintf(payload, "<html><title>Homepage</title><h1>Hello from your 3DS</h1><p>I'm running firmware %lu</p><p><a href="/sdcard/httpd/index.html">Click here.</a></p></html>", osGetFirmVersion());	response->payload = payload;
